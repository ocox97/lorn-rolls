...
export default function RateRollPage() {
...
.select("id,name,description")
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (!locationId) return; // should already be redirected
    ...
    // Back to place page after submit
    router.push(`/place/${encodeURIComponent(locationId)}`);
  }

  // While redirecting, show nothing (prevents flashing)
